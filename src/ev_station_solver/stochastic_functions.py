...
def ev_charging(ranges: np.ndarray, charging_probabilites: np.ndarray, seed: Optional[int] = None) -> np.ndarray:
    """
...
def generate_ranges(num: int, seed: Optional[int] = None) -> np.ndarray:
    """
